...
## 📊 Project Overview
This analysis explores how **different types of skills** relate to **median salary and skill demand** in the job market.
...
- Analyze **median salary by skill type**
...
- A **skills table** (`skill_jobs`)
- A **salary table** (`job_salary_all`)
...
- Accurate calculation of **median salary by skill**
...
3. Use slicers to filter by:
   - Country
   - Job Title
4. Review the combo chart to analyze **median salary vs skill count by skill**
...
## 📬 Contact
For questions or discussion about this project or data analyst opportunities, feel free to connect.
